                ...
                <div class="panel">
                    <div class="panel-body">
                        <div class="row filter-panel">
                            <div class="col-md-2"><input type="checkbox" value="弁本体" > 全部</div>
                            <div class="col-md-2"><input type="checkbox" value="弁本体" > 弁本体</div>
                            <div class="col-md-2"><input type="checkbox" value="付属品" > 付属品</div>
                            <div class="col-md-6"><button class="btn btn-success btn-sm pull-right" onclick="submitForm()">確定</button></div>
                        </div>
                        <div class="kiki-content-panel">
                            <div class="col-md-3" style="padding-right: 0px">
                                <div class="list-group tab-list">
                                ...
                                <ul class="list-group item-list">
                                    <li class="list-group-item">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <select class="form-control input-xs"><option>1</option></select>
                                            </div>
                                        </div>

                                    </li>

                                    <li class="list-group-item">aaaaaaaaaaaaaaaaaaaaaa</li>
